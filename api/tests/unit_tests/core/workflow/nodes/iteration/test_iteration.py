...
def test_run():
    ...
    pool.add(["pe", "list_output"], ["can20-1", "can20-2"])
    ...
    def tt_generator(self):
        return NodeRunResult(
            ...
            inputs={"iterator_selector": "can20"},
            outputs={"output": "can20 123"},
        )
    ...
    with patch.object(TemplateTransformNode, "_run", new=tt_generator):
        ...
        for item in result:
            ...
            if isinstance(item, RunCompletedEvent):
                ...
                assert item.run_result.outputs == {"output": ["can20 123", "can20 123"]}
