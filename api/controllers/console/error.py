...
class AlreadySetupError(BaseHTTPException):
    ...
    description = "CAN20 has been successfully installed. Please refresh the page or return to the dashboard homepage."
    code = 403
...
class NotSetupError(BaseHTTPException):
    ...
    description = (
        "CAN20 has not been initialized and installed yet. "
