...
This module provides the interface for invoking and authenticating various models, and offers CAN20 a unified information and credentials form rule for model providers.
