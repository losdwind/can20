    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> PGVectoRS:
        ...
        return PGVectoRS(
            ...
            config=PgvectoRSConfig(
                host=can20_config.PGVECTO_RS_HOST or "localhost",
                port=can20_config.PGVECTO_RS_PORT or 5432,
                user=can20_config.PGVECTO_RS_USER or "postgres",
                password=can20_config.PGVECTO_RS_PASSWORD or "",
                database=can20_config.PGVECTO_RS_DATABASE or "postgres",
            ),
            dim=dim,
        )
