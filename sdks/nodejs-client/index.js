...
export class CompletionClient extends CAN20Client {
...
export class ChatClient extends CAN20Client {
  createChatMessage(
    inputs,
    query,
    user,
...
export class WorkflowClient extends CAN20Client {
