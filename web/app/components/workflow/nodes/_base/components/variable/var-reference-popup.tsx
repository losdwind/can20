            ...
            <ListEmpty
              ...
              description={<div className='text-text-tertiary system-xs-regular'>
                ...
                <a target='_blank' rel='noopener noreferrer'
                  ...
                  href={locale !== LanguagesSupported[1] ? 'https://docs.chainainexus.com/guides/workflow/variables#conversation-variables' : `https://docs.chainainexus.com/${locale.toLowerCase()}/guides/workflow/variables#hui-hua-bian-liang`}>{t('workflow.variableReference.conversationVars')}</a>
              </div>}
            />
          ))
        : <VarReferenceVars
