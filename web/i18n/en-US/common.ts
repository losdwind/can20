const translation = {
  ...
  account: {
    ...
    chainAINexusAccount: 'CAN20 account',
    chainAINexusAccountTip: 'Your CAN20 account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to CAN20 to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by CAN20 allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across CAN20\'s applications.',
    link: 'Learn how to develop your own API Extension.',
    linkUrl: 'https://docs.chainainexus.com/features/extension/api_based_extension',
  ...
  about: {
    ...
    nowAvailable: 'CAN20 {{version}} is now available.',
    latestAvailable: 'CAN20 {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
