...
Welcome to the new `docker` directory for deploying CAN20 using Docker Compose. This README outlines the updates, deployment instructions, and migration details for existing users.
...
### How to Deploy CAN20 with `docker-compose.yaml`
...
### How to Deploy Middleware for Developing CAN20
